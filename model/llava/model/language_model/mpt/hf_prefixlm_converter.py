...
def _expand_mask_compat(mask, dtype, tgt_length=None):
...
def _make_causal_mask_compat(input_ids_shape, dtype, device=None, past_key_values_length=0):
...
try:
    ...
    _expand_mask_bloom = _expand_mask_compat
    _make_causal_mask_bloom = _make_causal_mask_compat
...
try:
    ...
    _expand_mask_opt = _expand_mask_compat
    _make_causal_mask_opt = _make_causal_mask_compat
