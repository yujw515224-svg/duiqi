...
def get_mask_from_json(json_path, img):
    ...
    inform = anno["shapes"]
    comments = anno["text"]
    fp_qa = anno.get("false_premise_QA", [])  # Modified line
...
if __name__ == "__main__":
    ...
    for json_path in json_path_list:
        ...
        # Updated to handle the additional return value from get_mask_from_json
        mask, comments, fp_qa, is_sentence = get_mask_from_json(json_path, img)
